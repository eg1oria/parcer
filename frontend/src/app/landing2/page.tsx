...
function OfferCard({ item, delay }: OfferCardProps) {
  ...
  return (
    <Reveal delay={delay}>
      ...
      >
        ...
        <p style={{ fontSize: 13, lineHeight: 1.85, color: "var(--text-dim)" }}>
          {item.desc}
        </p>
      </div>
    </Reveal>
...
export default function App() {
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => setHeroIn(true), 100);
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span>Специальное предложение для заведений</span>
          <span style={{ opacity: 0.5 }}>-</span>
        </p>
      ...
      >
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <Reveal delay={0.2}>
            ...
            >
              Сегодня человек принимает решение, куда пойти, за 7 секунд. Он
              открывает телефон, вводит «кафе рядом» и видит того, кто
              позаботился о своём присутствии в сети. Если вашего сайта нет или
              он выглядит устаревшим, этого человека вы уже потеряли. Он пошёл
              туда, где красиво, понятно и убедительно.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.3}>
            ...
            >
              {[
                {
                  num: "87%",
                  label: "гостей изучают заведение\nонлайн перед визитом",
                },
                {
                  num: "3x",
                  label: "больше броней приносит\nхороший лендинг",
                },
                {
                  num: "7 сек",
          ...
          <Reveal delay={0.15}>
            ...
            >
              ...
              <span style={{ color: "var(--gold)", fontStyle: "normal" }}>
                инвестиция, которая возвращается
              </span>
              <br />
      ...
      >
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <Reveal delay={0.2}>
            ...
            >
              <BtnPrimary href="mailto:hello@example.com">Написать сейчас</BtnPrimary>
              <BtnSecondary href="tel:+79000000000">Позвонить</BtnSecondary>
            </div>
          </Reveal>
